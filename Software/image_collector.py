...
galaxy_names: Series = read_csv(CSV_PATH)["Name"][14542:14554].unique() # remove [] for whole image collection
...
for name in galaxy_names:
    ...
    if image_list == []: continue
    names_with_images.append(name)
    request = commons.FileContainer(image_list[0], encoding='binary', show_progress=False).get_fits()
